...
%%%%%%%%%%%%%%%%% 存储  (训练  测试  步数)
% filename = ['results/' num2str(Best_TrainErr) '_' num2str(Best_TestErr) '_' num2str(Best_Epoch) '.mat'];
%     save(filename);
% save('SCVNFM_1Result0.051074.mat')
...
% filename2 = ['results/' 'ZZZ_' num2str(Mean_TrainMSE) '_' num2str(Mean_TestMSE) '_' num2str(Mean_Epoch) '.txt'];
