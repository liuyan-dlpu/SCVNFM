   ...
   for i=1:SampleNum
     ...
     for TF = 1 : SampleNum
         ...
         elseif NetworkOut(TF)>=3.5 && NetworkOut(TF)<4.5
             NetworkOut(TF) = 4;
         elseif NetworkOut(TF)>=4.5 && NetworkOut(TF)<5.5
             NetworkOut(TF) = 5;
         elseif NetworkOut(TF)>=5.5
             NetworkOut(TF) = 6;
         end
     end
     ...
     for TTF = 1 : TestNum
         ...
         elseif TestOut(TTF)>=3.5 && TestOut(TTF)<4.5
             TestOut(TTF) = 4;
         elseif TestOut(TTF)>=4.5 && TestOut(TTF)<5.5
             TestOut(TTF) = 5;
         elseif TestOut(TTF)>=5.5
             TestOut(TTF) = 6;
         end
     end
